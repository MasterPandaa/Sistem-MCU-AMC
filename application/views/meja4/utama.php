<html>
    ...
    <?php $this->load->view("meja3/navbar.php") ?>
        ...
        <div clacss="section">
			<div class="container">
                <h3>Daftar Pasien</h3>
                <a href="<?php echo base_url('meja4/sudah_cetak/'); ?>" class="previous"><button style="float: left;"  type="button" class="btn btn-success">Daftar Yang Sudah Diprint</button></a>
