                ...
                <?php foreach($hasil as $u){ 
                    $tgl_periksa = date('d-m-Y', strtotime($u->tgl_periksa))?>
                        <table style="width: 100%;">
                            <tr>
                                <td style="width: 50%; vertical-align: top;">
                                    <table>
                                        <tr>
                                            <td style="width: 100px"><font size="3" face="Arial">Nama</font></td>
                                            <td style="width: 10%"><font size="3" face="Arial">:</font></td>
                                            <td style="width: 170%"><font size="3" face="Arial"><?php echo $u->nama ?></font></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 100px"><font size="3" face="Arial">Tanggal Lahir</font></td>
                                            <td style="width: 10%"><font size="3" face="Arial">:</font></td>
                                            <td style="width: 170%"><font size="3" face="Arial"><?php echo $u->tgl_lahir ?></font></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 100px"><font size="3" face="Arial">Unit Kerja</font></td>
                                            <td style="width: 10%"><font size="3" face="Arial">:</font></td>
                                            <td style="width: 170%"><font size="3" face="Arial"><?php echo $u->prodi ?></font></td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="width: 50%; vertical-align: top;">
                                    <table>
                                        <tr>
                                            <td style="width: 150px"><font size="3" face="Arial">Jenis Kelamin</font></td>
                                            <td style="width: 10%"><font size="3" face="Arial">:</font></td>
                                            <td style="width: 120%"><font size="3" face="Arial"><?php echo $u->jk ?></font></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 150px"><font size="3" face="Arial">Status Pernikahan</font></td>
                                            <td style="width: 10%"><font size="3" face="Arial">:</font></td>
                                            <td style="width: 120%"><font size="3" face="Arial"><?php echo $u->stts_pernikahan ?></font></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 150px"><font size="3" face="Arial">Usia</font></td>
                                            <td style="width: 10%"><font size="3" face="Arial">:</font></td>
                                            <td style="width: 120%"><font size="3" face="Arial"><?php echo $u->usia ?> tahun</font></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        <table class="table border kanan">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="border" scope="row" colspan="6" style="width: 600px"><font size="2" face="Arial"><center><?php echo $u->kesimpulan ?></center></font></td>
                        ...
                        <table class="table kanan4">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td  scope="row"style="width: 100px;"><font size="2" face="Arial"></font></td>
                                            <td  scope="row"style="width: 100px"><font size="2" face="Arial"></font></td>
                                            <td  scope="row"style="width: 350px"><font size="2" face="Arial"><center><u>dr. Mita Wulansari, MARS</u></center></font></td>
