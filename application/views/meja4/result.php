			...
			<div class="container">
                ...
                <form action="<?php echo base_url(). 'meja3/periksa'; ?>" method="post" name="form">	
                    <div class="row">
                                ...
                                <div class="col-md-3 col-sm-3">    
                                        <label for="poli">Lingkar Perut</label>
                                        <input type="text" class="form-control" id="lingkar_perut" name="lingkar_perut" value="<?php echo $u->lingkar_perut ?> cm" readonly>
                                        <span id="MsgIsi5" style="color:#CC0000; font-size:10px;"></span>
                                </div>
                                <div class="col-md-3 col-sm-3">    
                                ...
                                <div class="col-md-12 col-sm-12">
				                        ...
				                        <input type="text" class="form-control" id="saran" name="saran" placeholder="Masukan Saran">
                                        <span id="MsgIsi1" style="color:#CC0000; font-size:10px;"></span>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                        ...
                                        <option value="dr. Mita Wulansari">dr. Mita Wulansari</option>
                                        <option value="dr. Syahrizal Ardhiyand Hidayat">dr. Syahrizal Ardhiyand Hidayat</option>
                                    </select>
                                </div><br><br><br><br>
                                <div class="col-md-12 col-sm-12">
                                        <button type="submit" class="btn btn-primary">SIMPAN</button>&nbsp;
                                        <a href="<?php echo base_url('meja4/index/'); ?>" class="previous"><button type="button" class="btn btn-danger">Kembali</button></a>
                                </div>
                        </div>
