                ...
                <?php foreach($hasil as $u){ 
                    $tgl_periksa = date('d-m-Y', strtotime($u->tgl_periksa))?>
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <td colspan="3" style="font-weight: bold; font-size: 14px; font-family: Arial;">A. Kesimpulan</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3" style="font-weight: bold; font-size: 14px; font-family: Arial;">B. Saran</td>
                            </tr>
                            <tr>
                                <td style="width: 5%; font-size: 12px; font-family: Arial; padding-left: 40px;"></td>
                            ...
                            <tr>
                                <td colspan="3" style="font-weight: bold; font-size: 14px; font-family: Arial;">C. Tindah Lanjut</td>
                            </tr>
                            <tr>
                                <td style="width: 5%; font-size: 12px; font-family: Arial; padding-left: 40px;"></td>
