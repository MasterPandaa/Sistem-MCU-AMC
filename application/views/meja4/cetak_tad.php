                ...
                <?php foreach($hasil as $u){ 
                    $tgl_periksa = date('d-m-Y', strtotime($u->tgl_periksa))?>
                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                <td colspan="3" style="font-weight: bold; font-size: 14px; font-family: Arial;">C. Hasil Pemeriksaan Rontgen</td>
                            </tr>
                            <tr>
                                <td style="width: 5%; font-size: 12px; font-family: Arial; padding-left: 40px;"></td>
                                <td style="width: 95%; font-size: 12px; font-family: Arial;"><?php echo $u->pemeriksaan_rontgen; ?></td>
                            </tr>
                            <tr>
                                <td colspan="3" style="font-weight: bold; font-size: 14px; font-family: Arial;">D. Kesimpulan</td>
                            </tr>
                            <tr>
                                <td style="width: 5%; font-size: 12px; font-family: Arial; padding-left: 40px;"></td>
                            ...
                            <tr>
                                <td colspan="3" style="font-weight: bold; font-size: 14px; font-family: Arial;">E. Saran</td>
                            </tr>
                            <tr>
                                <td style="width: 5%; font-size: 12px; font-family: Arial; padding-left: 40px;"></td>
                            ...
                            <tr>
                                <td colspan="3" style="font-weight: bold; font-size: 14px; font-family: Arial;">F. Tindah Lanjut</td>
                            </tr>
                            <tr>
                                <td style="width: 5%; font-size: 12px; font-family: Arial; padding-left: 40px;"></td>
