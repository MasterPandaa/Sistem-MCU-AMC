<html>
   ...
   <!--         <h3>Pencarian</h3>-->
			<!--<hr>-->
			<!--<form action="<?php echo base_url('meja1/hasil')?>" action="GET">-->
                ...
                <table class="table table-striped table-bordered table-sm table-paginate">
                    ...
                    foreach ($pasien as $pasien): ?>
                        <tr>
                            ...
                            <td> <a href="<?php echo base_url('meja1/label/'.$pasien->id); ?>" class="previous"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-print"></span></button></a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
