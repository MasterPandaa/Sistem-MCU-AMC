			...
			<div class="container">
                ...
                <form action="<?php echo base_url(). 'meja3/periksa'; ?>" method="post" name="form">	
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <h4 style="color: #29166f;"><b>Pemeriksaan Dokter Gigi</b></h4>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <label>Hasil Pemeriksaan Gigi dan Mulut</label>
                            <input type="text" class="form-control" value="<?php echo $u->hasil_pemeriksaan_gigi ?>" readonly>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <label>Kesimpulan Dokter Gigi</label>
                            <textarea class="form-control" rows="3" readonly><?php echo $u->kesimpulan_gigi ?></textarea>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <label>Saran Dokter Gigi</label>
                            <textarea class="form-control" rows="3" readonly><?php echo $u->saran_gigi ?></textarea>
                        </div>
                        <br><br>
                        <!-- Pemeriksaan Dokter Mata -->
                        <div class="col-md-12 col-sm-12">
                            <h4 style="color: #29166f;"><b>Pemeriksaan Dokter Mata</b></h4>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <label>Hasil Pemeriksaan Mata</label>
                            <input type="text" class="form-control" value="<?php echo $u->hasil_pemeriksaan_mata ?>" readonly>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <label>Visus</label>
                            <input type="text" class="form-control" value="<?php echo $u->visus ?>" readonly>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <label>Tonometri</label>
                            <input type="text" class="form-control" value="<?php echo $u->tonometri ?>" readonly>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <label>Kesimpulan Dokter Mata</label>
                            <textarea class="form-control" rows="3" readonly><?php echo $u->kesimpulan_mata ?></textarea>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <label>Saran Dokter Mata</label>
                            <textarea class="form-control" rows="3" readonly><?php echo $u->saran_mata ?></textarea>
                        </div>
                        <br><br>
