			...
			<div class="container">
                ...
                <form action="<?php echo base_url(). 'meja3/periksa'; ?>" method="post" name="form">	
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <label for="pemeriksaan_lab">Hasil Pemeriksaan Laboratorium</label>
                            <textarea class="form-control" id="pemeriksaan_lab" name="pemeriksaan_lab" rows="3" placeholder="Masukkan Hasil Pemeriksaan Laboratorium"><?php echo $u->pemeriksaan_lab; ?></textarea>
                        </div>
                        <br><br>
                        <!-- Non-Laboratorium -->
                        <div class="col-md-12 col-sm-12">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <label for="pemeriksaan_non_lab">Hasil Pemeriksaan Non-Laboratorium</label>
                            <textarea class="form-control" id="pemeriksaan_non_lab" name="pemeriksaan_non_lab" rows="3" placeholder="Masukkan Hasil Pemeriksaan Non-Laboratorium"><?php echo $u->pemeriksaan_non_lab; ?></textarea>
                        </div>
                        <br><br>
                        <!-- Rontgen -->
                        <div class="col-md-12 col-sm-12">
                            <h4 style="color: #29166f;"><b>Pemeriksaan Rontgen</b></h4>
                        </div>
                        <div class="col-md-12 col-sm-12">
                            <label for="pemeriksaan_rontgen">Hasil Pemeriksaan Rontgen</label>
                            <textarea class="form-control" id="pemeriksaan_rontgen" name="pemeriksaan_rontgen" rows="3" placeholder="Masukkan Hasil Pemeriksaan Rontgen"><?php echo $u->pemeriksaan_rontgen; ?></textarea>
                        </div>
                        <br><br>
                        <!-- Resume -->
                        <div class="col-md-12 col-sm-12">
